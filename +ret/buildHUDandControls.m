...
mkLabel('Last Row Offset (in)', yTop-10*dy);
S.edLast = mkEdit(S.lastRowZ, yTop-10*dy, 'lastRowZ');
set(S.edLast, 'BackgroundColor', mainYellow);
mkLabel('Pin Diameter (in)', yTop-11*dy);
...
mkLabel('Pin Pattern*', yTop-12*dy);
...
mkLabel('View Toggle', yTop-13*dy);
